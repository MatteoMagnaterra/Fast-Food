...
class VisualizzaAccountCliente(QtWidgets.QWidget):
    def __init__(self, cliente):
        super().__init__()
        self.cliente = cliente
        self.setWindowTitle("Fast-Food - Visualizza Account Cliente")
    ...
    def init_ui(self):
        ...
        # Disabilita i campi in modo che non siano modificabili
        ...
        # Collegamento del pulsante elimina account alla funzione delete_account
        self.elimina_button.clicked.connect(self.delete_account)
    ...
    def carica_dati_cliente(self):
        ...
        self.cognome_edit.setText(self.cliente.cognome)
        self.email_edit.setText(self.cliente.email)
        self.password_edit.setText(self.cliente.password)  # Visualizza la password in chiaro
        self.telefono_edit.setText(self.cliente.telefono)
        self.username_edit.setText(self.cliente.username)
    ...
    def delete_account(self):
        ...
        if confirm == QtWidgets.QMessageBox.Yes:
            ...
            QtWidgets.QMessageBox.information(self, "Account Eliminato", "Il tuo account è stato eliminato con successo.")
    ...
    def modifica_account(self):
        if not self.in_modifica:
            ...
            if self.cliente.modifica_account(nuovi_dati):
                ...
                QtWidgets.QMessageBox.warning(self, "Errore",
                                              "Username o codice già in uso. Scegli valori diversi.")


if __name__ == "__main__":
    app = QtWidgets.QApplication(sys.argv)
    cliente = Cliente("ES", "S", "k@j.a", "elia03", "1234567891", "123", "NNBI")
    window = VisualizzaAccountCliente(cliente)
    window.show()
    sys.exit(app.exec())